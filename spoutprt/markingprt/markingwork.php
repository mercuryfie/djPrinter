<?php
	...
	case "markingenable":
		...
		case "domino":
			...
			$txt = str_replace(" ","",$sendTxt);
			$json["markingsetting_senddata_delay_txt"]=$txt;
			$res3=prt_sendrecv($socket_enable, $txt);
		...
		if(chkodCodelen($odcode))
		{
			...
			if($socket)
			{
				...
				else
				{
					...
					{
					case "domino":
						include $droot."domino.sendrecv.php";
						break;
					case "hp":
						include $droot."hp.sendrecv.php";
						break;
					}
				}
				...
				if($res1["state"] == true)
				{
					...
					{
					case "domino":
						include $droot."domino.sendrecv2.php";
						break;
					case "hp":
						include $droot."hp.sendrecv2.php";
						break;
					}
				}
				else
